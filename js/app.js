...
import { clearProject, loadProject, saveProject } from "./storage.js?v=166";
import { exportNotebookCsv } from "./export.js?v=166";
import {
...
} from "./point-names.js?v=166";
import { initializeAnalytics, trackEvent } from "./analytics.js?v=166";
...
const APP_RELEASE_VERSION = new URL(import.meta.url).searchParams.get("v") || "166";
