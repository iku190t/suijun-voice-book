...
import { clearProject, loadProject, saveProject } from "./storage.js?v=173";
import { exportNotebookCsv } from "./export.js?v=173";
import {
...
} from "./point-names.js?v=173";
import { initializeAnalytics, trackEvent } from "./analytics.js?v=173";
...
const APP_RELEASE_VERSION = new URL(import.meta.url).searchParams.get("v") || "173";
